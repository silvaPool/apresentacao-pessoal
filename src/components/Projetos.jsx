...
function Projetos() {
  return (
    <>
      <Box className="p-10 bg-gradient-to-r from-gray-100 via-gray-200 to-gray-300">
        <Box className="flex flex-col justify-between items-center h-96 gap-5 p-4 ">
          <p className="font-montserrat text-2xl font-semibold tracking-wider mb-5">
            Projetos
          </p>

          <Box className="flex flex-row justify-between items-center gap-4">
            <div class="w-64 bg-white shadow-[0px_0px_15px_rgba(0,0,0,0.09)] p-9 space-y-3 relative overflow-hidden">
