...
function Projetos() {
  return (
    <>
      <Box className="flex flex-col justify-between items-center h-96 gap-5 p-4 bg-gradient-to-r from-gray-100 via-gray-200 to-gray-300">
        <p className="font-montserrat text-2xl font-semibold tracking-wider mb-5">Projetos</p>
